...
print("Spaltennamen in population_df:", population_df.columns.tolist())
...
# 1. Highly Annoyed
def calculate_highly_annoyed_dalys(exposed_individuals, lden, noise_type_ha):
...
def calculate_high_sleep_disorder_dalys(exposed_individuals, lnight, noise_type_hsd):
...
def calculate_ihd_dalys(exposed_individuals, lden, noise_type, country):
    ...
    dalys = yld_noise + yll_noise
    return dalys

# 4. Diabetes
def calculate_diabetes_dalys(exposed_individuals, lden, noise_type, country):
    ...
    return dalys
# 5. Stroke
def calculate_stroke_dalys(exposed_individuals, lden, noise_type, country):
...
def calculate_total_dalys(exposed_individuals, lden, lnight,  noise_type_ha, noise_type_hsd, noise_type, country):
    dalys_ha = calculate_highly_annoyed_dalys(exposed_individuals, lden, noise_type_ha)
    dalys_hsd = calculate_high_sleep_disorder_dalys(exposed_individuals, lnight, noise_type_hsd)
    dalys_ihd = calculate_ihd_dalys(exposed_individuals, lden, noise_type, country)
    dalys_diabetes = calculate_diabetes_dalys(exposed_individuals, lden, noise_type, country)
    dalys_stroke = calculate_stroke_dalys(exposed_individuals, lden, noise_type, country)
...
if __name__ == "__main__":
    ...
    print("Highly Annoyed:", calculate_highly_annoyed_dalys(exposed, lden, noise_type_ha))
    print("Sleep Disorder:", calculate_high_sleep_disorder_dalys(exposed, lnight, noise_type_hsd))
    print("IHD:", calculate_ihd_dalys(exposed, lden, noise_type, country))
    print("Diabetes:", calculate_diabetes_dalys(exposed, lden, noise_type, country))
    print("Stroke:", calculate_stroke_dalys(exposed, lden, noise_type, country))
    print("Total", calculate_total_dalys(exposed, lden, lnight,  noise_type_ha, noise_type_hsd, noise_type, country))
